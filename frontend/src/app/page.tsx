...
export default function AIDemandLandingPage() {
  ...
  return (
    <div className="bg-[#000000] text-white min-h-screen relative font-sans overflow-x-hidden selection:bg-white selection:text-black">
      ...
      <section className="relative min-h-[90vh] sm:min-h-screen flex flex-col justify-between p-4 sm:p-8 lg:p-12 overflow-hidden bg-black border-b border-white/10">
        ...
        <div className="relative z-10 flex-1 flex flex-col justify-between max-w-[1600px] w-full mx-auto">
          ...
          <header className="grid grid-cols-[1fr_auto_1fr] items-center w-full select-none">
            ...
            <Link
              href="/"
              className="inline-flex items-center gap-2 sm:gap-2.5 justify-self-start text-sm sm:text-base font-semibold tracking-[-0.03em] text-white appear appear--scale"
            ...
            >
              ...
              <span className="font-bold truncate max-w-[170px] sm:max-w-none">AI Demand Intelligence</span>
            </Link>
            ...
            <div className="justify-self-end flex items-center gap-2 sm:gap-3">
              <Link
                href="/forecast"
                className="btn-solid appear appear--scale text-2xs sm:text-xs font-bold px-3 py-2 sm:px-4 sm:py-2"
              ...
              <button
                ...
                className="lg:hidden p-2 bg-black/60 backdrop-blur-md border border-white/20 text-white"
          ...
          {menuOpen && (
            <div className="fixed inset-0 z-50 bg-black/95 backdrop-blur-2xl lg:hidden flex flex-col justify-center items-center p-8 space-y-6">
          ...
          {/* MAIN HERO CONTENT */}
          <main className="mt-10 sm:mt-20 mb-8 sm:mb-12 flex flex-col items-center text-center max-w-[880px] mx-auto w-full px-2 sm:px-0">
            
            {/* EYEBROW BADGE */}
            <div
              className="inline-flex items-center gap-2 px-3.5 py-1.5 sm:px-4 sm:py-2 bg-gradient-to-r from-[#7d7d7d] via-[#2a2a2a] to-[#0a0a0a] text-[#f2f2f2] text-2xs sm:text-xs font-medium tracking-[-0.01em] mb-4 sm:mb-6 border border-white/10 appear appear--pop"
              style={{ "--d": "0.22s" } as React.CSSProperties}
            >
              <svg className="w-3.5 h-3.5 sm:w-4 sm:h-4 text-white fill-current filter drop-shadow-[0_0_3px_rgba(255,255,255,0.45)]" viewBox="0 0 24 24">
            ...
            <h1 className="text-[clamp(2.1rem,6vw,4.5rem)] font-medium leading-[1.12] tracking-[-0.045em] text-white break-words">
            ...
            <p
              className="mt-4 sm:mt-5 text-xs sm:text-base text-[#9a9a9a] max-w-[580px] leading-relaxed tracking-[-0.015em] appear appear--soft"
            ...
            <p className="mt-2 text-2xs sm:text-sm text-slate-400 font-mono">
              Upload your sales data. Generate explainable forecasts across products and stores.
            </p>

            {/* ACTION CTAs */}
            <div className="flex flex-col sm:flex-row flex-wrap justify-center gap-3 mt-6 sm:mt-8 w-full sm:w-auto">
              <Link
                href="/forecast"
                className="btn-solid h-[46px] sm:h-[48px] px-8 text-xs sm:text-sm font-bold appear appear--btn w-full sm:w-auto"
              ...
              <Link
                href="/dashboard"
                className="btn-ghost h-[46px] sm:h-[48px] px-8 text-xs sm:text-sm font-medium appear appear--side w-full sm:w-auto"
          ...
          <div className="pt-6 sm:pt-8 border-t border-white/10 flex flex-col sm:flex-row justify-between items-center gap-2 sm:gap-4 text-2xs sm:text-xs font-mono text-[#d8d8d8]">
            <span>✓ Multi-Horizon CatBoost Models</span>
      ...
      {/* ========================================================================= */}
      {/* 3. PROBLEM SECTION (ANIMATED MOTION CARDS)                                */}
      {/* ========================================================================= */}
      <section className="bg-[#050505] text-white py-16 sm:py-28 px-4 sm:px-8 border-b border-white/10">
        <div className="max-w-[1280px] mx-auto space-y-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="bg-[#0a0a0a] border border-white/10 p-8 space-y-3 card-motion cursor-pointer">
      ...
      {/* ========================================================================= */}
      {/* 4. SOLUTION SECTION (ANIMATED MOTION CARDS)                               */}
      {/* ========================================================================= */}
      <section id="how-it-works" className="bg-[#0a0a0a] text-white py-16 sm:py-28 px-4 sm:px-8 border-b border-white/10">
        <div className="max-w-[1280px] mx-auto space-y-12">
          <div className="max-w-3xl space-y-3">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-4">
            {[
              ...
              <div key={item.num} className="bg-[#121212] border border-white/10 p-6 space-y-3 card-motion-emerald cursor-pointer">
      ...
      {/* ========================================================================= */}
      {/* 5. CORE FEATURES SECTION (ANIMATED MOTION CARDS)                          */}
      {/* ========================================================================= */}
      <section id="product" className="bg-[#050505] text-white py-16 sm:py-28 px-4 sm:px-8 border-b border-white/10">
        <div className="max-w-[1280px] mx-auto space-y-12">
          <div className="max-w-3xl space-y-3">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="bg-[#0a0a0a] border border-white/10 p-8 space-y-3 card-motion group cursor-pointer">
              <TrendingUp className="w-7 h-7 text-indigo-400 group-hover:scale-110 transition-transform duration-300" />
            ...
            <div className="bg-[#0a0a0a] border border-white/10 p-8 space-y-3 card-motion-amber group cursor-pointer">
              <Sparkles className="w-7 h-7 text-amber-400 group-hover:scale-110 transition-transform duration-300" />
            ...
            <div className="bg-[#0a0a0a] border border-white/10 p-8 space-y-3 card-motion-emerald group cursor-pointer">
              <BarChart3 className="w-7 h-7 text-emerald-400 group-hover:scale-110 transition-transform duration-300" />
            ...
            <div className="bg-[#0a0a0a] border border-white/10 p-8 space-y-3 card-motion group cursor-pointer">
              <Activity className="w-7 h-7 text-cyan-400 group-hover:scale-110 transition-transform duration-300" />
            ...
            <div className="bg-[#0a0a0a] border border-white/10 p-8 space-y-3 card-motion group cursor-pointer">
              <Cpu className="w-7 h-7 text-purple-400 group-hover:scale-110 transition-transform duration-300" />
            ...
            <div className="bg-[#0a0a0a] border border-white/10 p-8 space-y-3 relative overflow-hidden card-motion-amber group cursor-pointer">
      ...
      {/* ========================================================================= */}
      {/* 6. EXPLAINABILITY SECTION (ANIMATED MOTION CARDS)                         */}
      {/* ========================================================================= */}
      <section id="explainability" className="bg-[#0a0a0a] text-white py-16 sm:py-28 px-4 sm:px-8 border-b border-white/10">
        <div className="max-w-[1280px] mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="bg-[#121212] border border-white/10 p-8 space-y-6 card-motion-amber cursor-pointer">
            ...
            <div className="space-y-4 font-mono text-xs">
              <div>
                ...
                <div className="w-full bg-[#0a0a0a] h-2"><div className="bg-emerald-500 h-full w-[31%] transition-all duration-1000"></div></div>
              </div>
              ...
              <div>
                ...
                <div className="w-full bg-[#0a0a0a] h-2"><div className="bg-emerald-500 h-full w-[22%] transition-all duration-1000"></div></div>
              </div>
              ...
              <div>
                ...
                <div className="w-full bg-[#0a0a0a] h-2"><div className="bg-emerald-500 h-full w-[15%] transition-all duration-1000"></div></div>
              </div>
              ...
              <div>
                ...
                <div className="w-full bg-[#0a0a0a] h-2"><div className="bg-indigo-500 h-full w-[9%] transition-all duration-1000"></div></div>
              </div>
              ...
              <div>
                ...
                <div className="w-full bg-[#0a0a0a] h-2"><div className="bg-rose-500 h-full w-[6%] transition-all duration-1000"></div></div>
              </div>
            </div>
          </div>
        </div>
      ...
      {/* ========================================================================= */}
      {/* 7. BUSINESS INTELLIGENCE SECTION (ANIMATED MOTION CARDS)                  */}
      {/* ========================================================================= */}
      <section className="bg-[#050505] text-white py-16 sm:py-28 px-4 sm:px-8 border-b border-white/10">
        <div className="max-w-[1280px] mx-auto space-y-12">
          <div className="max-w-3xl space-y-3">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="bg-[#0a0a0a] border border-white/10 p-8 space-y-3 card-motion-emerald cursor-pointer">
            ...
            <div className="bg-[#0a0a0a] border border-white/10 p-8 space-y-3 card-motion-rose cursor-pointer">
              <div className="flex items-center justify-between">
            ...
            <div className="bg-[#0a0a0a] border border-white/10 p-8 space-y-3 card-motion-amber cursor-pointer">
              <div className="flex items-center justify-between">
      ...
      {/* ========================================================================= */}
      <section id="ai-analyst" className="bg-[#0a0a0a] text-white py-16 sm:py-28 px-4 sm:px-8 border-b border-white/10">
        <div className="max-w-[1280px] mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div className="space-y-4">
          ...
          <div className="bg-[#121212] border border-white/10 p-8 space-y-4 font-mono text-xs card-motion-amber cursor-pointer">
            ...
            {[
              ...
              <div key={q} className="bg-[#0a0a0a] p-3 rounded border border-white/5 text-slate-300 flex items-center gap-2 hover:border-amber-500/40 transition-colors">
      ...
      {/* ========================================================================= */}
      <section id="performance" className="bg-[#050505] text-white py-16 sm:py-28 px-4 sm:px-8 border-b border-white/10">
        <div className="max-w-[1280px] mx-auto space-y-12">
          <div className="max-w-3xl space-y-3">
          ...
          <div className="bg-[#0a0a0a] border border-white/10 p-6 overflow-x-auto card-motion">
      ...
      {/* ========================================================================= */}
      {/* 10. TECHNOLOGY / TRUST SECTION (ANIMATED MOTION CARDS)                     */}
      {/* ========================================================================= */}
      <section className="bg-[#0a0a0a] text-white py-16 sm:py-28 px-4 sm:px-8 border-b border-white/10">
        <div className="max-w-[1280px] mx-auto space-y-12">
          <div className="max-w-3xl space-y-3">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="bg-[#121212] border border-white/10 p-6 space-y-2 card-motion cursor-pointer">
          ...
          <div className="flex flex-wrap items-center justify-center gap-3 font-mono text-xs">
            {[
              ...
              <div key={step} className="flex items-center gap-3">
                <span className="px-4 py-3 bg-[#0a0a0a] border border-white/10 text-slate-200 font-semibold card-motion-emerald cursor-pointer">
                  {step}
                </span>
      ...
      {/* ========================================================================= */}
      <section className="bg-[#0a0a0a] text-white py-20 sm:py-32 px-4 sm:px-8 text-center border-b border-white/10">
        <div className="max-w-3xl mx-auto space-y-6">
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-4 pt-4">
            <Link
              href="/forecast"
              className="btn-solid h-[50px] px-8 text-xs sm:text-sm font-bold w-full sm:w-auto"
            >
              Start Forecasting
            </Link>
            <Link
              href="/dashboard"
              className="btn-ghost h-[50px] px-8 text-xs sm:text-sm font-medium w-full sm:w-auto"
            >
              Explore Demo
            </Link>
          </div>
      ...
      {/* 13. FOOTER                                                                */}
      {/* ========================================================================= */}
      <footer className="bg-[#000000] text-slate-400 py-12 sm:py-16 px-4 sm:px-8 text-xs font-mono">
        <div className="max-w-[1280px] mx-auto grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 sm:gap-12 border-b border-white/10 pb-8 sm:pb-12">
          ...
          <div className="space-y-2">
            ...
            <ul className="space-y-1.5 text-slate-400">
              <li><Link href="/forecast" className="hover:text-white transition-colors">Forecasting</Link></li>
              <li><Link href="/explainability" className="hover:text-white transition-colors">Explainability</Link></li>
              <li><Link href="/eda" className="hover:text-white transition-colors">Store Intelligence</Link></li>
              <li><Link href="/eda" className="hover:text-white transition-colors">Product Intelligence</Link></li>
              <li><Link href="/analyst" className="hover:text-white transition-colors">AI Analyst</Link></li>
            </ul>
          </div>
          ...
          <div className="space-y-2">
            ...
            <ul className="space-y-1.5 text-slate-400">
              <li><a href="https://demand-intelligence-api.onrender.com/docs" target="_blank" rel="noreferrer" className="hover:text-white transition-colors">Documentation / API</a></li>
              <li><a href="https://github.com/VedantJadhav701/ai-demand-intelligence-platform" target="_blank" rel="noreferrer" className="hover:text-white transition-colors">GitHub Repository</a></li>
            </ul>
          </div>
        </div>

        <div className="max-w-[1280px] mx-auto pt-6 sm:pt-8 flex flex-col sm:flex-row justify-between items-center gap-2 text-3xs text-slate-600">
